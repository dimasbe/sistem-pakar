...
@section('page-title', 'Tambah Karir')
...
@section('content')
    <div class="max-w-full">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <form id="karirForm" action="{{ route('admin.karir.store') }}" method="POST" novalidate>
                @csrf
                <div class="grid grid-cols-1 gap-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_karir" id="nama_karir" value="{{ old('nama_karir') }}"
                                ...
                                <select name="id_kepribadian" id="id_kepribadian"
                                    ...
                                    @foreach ($kepribadian as $kp)
                                        <option value="{{ $kp->id_kepribadian }}"
                                            {{ old('id_kepribadian') == $kp->id_kepribadian ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi_karir" id="deskripsi_karir" rows="5"
                            ...
                            placeholder="Jelaskan tentang pekerjaan ini...">{{ old('deskripsi_karir') }}</textarea>
                    </div>
