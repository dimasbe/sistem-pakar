...
@section('content')
    <div class="max-w-full">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <form id="pertanyaanForm" action="{{ route('admin.pertanyaan.store') }}" method="POST" novalidate>
                @csrf
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="teks_pertanyaan" id="teks_pertanyaan" rows="5"
                            ...
                            placeholder="Contoh: Apakah Anda suka bekerja dengan mesin atau alat teknik?">{{ old('teks_pertanyaan') }}</textarea>
                    </div>
