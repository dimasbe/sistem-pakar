...
@section('title', 'Tambah Kepribadian')
@section('page-title', 'Tambah Kepribadian')
...
@section('content')
    <div class="max-w-full">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <form id="kepribadianForm" action="{{ route('admin.kepribadian.store') }}" method="POST" novalidate>
                @csrf
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="6"
                            ...
                            placeholder="Jelaskan karakteristik tipe kepribadian ini...">{{ old('deskripsi') }}</textarea>
                    </div>
    ...
    <script>
        document.getElementById('kepribadianForm').addEventListener('submit', function(e) {
            let errors = [];
